                    ...
                    <div class="card-body">
                        ...
                        <form id="student-form">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="req_picture" name="req_picture">
                                <label class="form-check-label" for="req_picture">Picture 2x2 (1pc.)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="req_good_moral" name="req_good_moral">
                                <label class="form-check-label" for="req_good_moral">Certificate of Good Moral Character</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="req_form_138" name="req_form_138">
                                <label class="form-check-label" for="req_form_138">Form 138 (HS Card)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="req_honorable_dismissal" name="req_honorable_dismissal">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.form-check-input').change(function() {
                // Set the value of the checkbox to true if it's checked, false otherwise
        ...
        $('#submit-button').click(function(e) {
            ...
            const formData = {
                ...
                req_picture: $('#req_picture').val(),
                req_good_moral: $('#req_good_moral').val(),
                req_form_138: $('#req_form_138').val(),
                req_honorable_dismissal: $('#req_honorable_dismissal').val(),
